...
@Component({
  selector: 'app-timer-group-chats',
  templateUrl: './timer-group-chats.component.html',
  styleUrls: ['./timer-group-chats.component.scss']
})
export class TimerGroupChatsComponent implements OnInit {
